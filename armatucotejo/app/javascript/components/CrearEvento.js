...
class NuevoEvento extends React.Component{
  render(){
        ...
        <div>
          <div className="container">
            ...
            <h2 class="formulario">Crear Evento</h2>
              ...
              <div class="center divbutton"><a class="link nav-link" href="/NuevoEvento"><button class="btn buttonhome btn-lg thirdbc ">Crear</button></a><h6 class="comfortaa firstc regbutton"></h6></div>
              </div>
            </div>
          </div>
        </div>
