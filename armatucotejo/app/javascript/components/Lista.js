...
class Lista extends React.Component{
  ...
  <div class="ui card fourbc">
    <div className="card-header" role="tab" id="headingOne1">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
        aria-controls="collapseOne1">
        <h5 className="mb-0 fivec">
          Futbol <i className="fas fa-angle-down rotate-icon"><span className="badge badge-primary badge-pill thirdbc">14</span></i>
        </h5>
      </a>
    </div>

    <div id="collapseOne1" className="collapse show" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordionEx">
      <div class="card-body secondc">
        Pumarejo
      </div>
    </div>
  </div>
  <div class="ui card fourbc">
    <div className="card-header" role="tab" id="headingOne2">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne2" aria-expanded="true"
        ...
        <h5 className="mb-0 fivec">
          Futsal <i className="fas fa-angle-down rotate-icon"><span className="badge badge-primary badge-pill thirdbc">14</span></i>
        </h5>
      </a>
    </div>
  ...
  <div class="ui card fourbc">
    <div className="card-header" role="tab" id="headingOne3">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne3" aria-expanded="true"
        ...
        <h5 className="mb-0 fivec">
          Voleyball<i className="fas fa-angle-down rotate-icon"><span className="badge badge-primary badge-pill thirdbc">1</span></i>
        </h5>
      </a>
    </div>
  ...
  <div class="ui card fourbc">
    <div className="card-header" role="tab" id="headingOne4">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne4" aria-expanded="true"
        ...
        <h5 className="mb-0 fivec">
          Basketball <i className="fas fa-angle-down rotate-icon"><span className="badge badge-primary badge-pill thirdbc">1</span></i>
        </h5>
      </a>
    </div>
